...
do
  ...
  locust -f locust-sqs-load-test.py --worker &
...
echo "Start primary..."
locust -f locust-sqs-load-test.py --master --host $KINESIS_DEFAULT_STREAM_NAME --web-auth $LOCUST_DASHBOARD_USER:$LOCUST_DASHBOARD_PWD
